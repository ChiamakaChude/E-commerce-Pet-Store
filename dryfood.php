...
<html>
    ...
    <body id="bod">
        ...
        <div class="container-fluid" id="page-container">
            <div id="products">
                    <div class="row">
                        <?php $data=$conn->query('SELECT * FROM products WHERE category LIKE "%food%" AND animal="dog"')->fetchAll();
                        $products = array();
...
'><br>&#8358;".number_format($row["old_price"],2)."</span></p>
                                    <button type='button' class='btn' id='add'><i class='fa fa-shopping-cart'></i> Add to cart</button>
                                </div>
                            </div>";                    
